CREATE DATABASE IF NOT EXISTS perf_dish_memo DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- add extra for later clean work
ALTER TABLE dish_record ADD COLUMN test_run_id VARCHAR(64);
